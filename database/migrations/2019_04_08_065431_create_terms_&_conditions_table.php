...
class CreateTerms&ConditionsTable extends Migration
{
    ...
    public function up()
    {
        Module::generate("Terms_&_conditions", 'terms_&_conditions', 'content', 'fa-file-text', [
            ["content", "Contetn", "Textarea", false, "", 0, 0, false],
        ]);
    ...
    {
        if (Schema::hasTable('terms_&_conditions')) {
            Schema::drop('terms_&_conditions');
        }
    }
}
